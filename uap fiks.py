...
print(colored("Jawab beberapa pertanyaan berikut dengan jujur untuk mendapatkan saran kesehatan dasar.", "cyan"))
...
def konsultasi_kesehatan():
    ...
    # gigi
    if gigi == 'y':
        saran_gigi = "[gigi] Nice! Lanjutkan kebiasaan baik Anda."
    else:
        saran_gigi = "[gigi] Saran: Biasakan untuk menyikat gigi minimal 2x sehari."
    print(colored(saran_gigi, "cyan"))

    # makan
    if makan == 'y':
        saran_makan = "[makan] Nice! Lanjutkan kebiasaan baik Anda."
    else:
        saran_makan = "[makan] Saran: Biasakan makan 3x dalam sehari agar kebutuhan nutrisi yang diperlukan oleh tubuh dapat terpenuhi."
    print(colored(saran_makan, "cyan"))

    # tidur
    if tidur == 'y':
        saran_tidur = "[tidur] Nice! Lanjutkan kebiasaan baik Anda."
    else:
...
Biodata = {
    "Kelompok"         : 29,
    "Anggota "         : "Angelina Zaskya Hulda (2310432041)",
    " "                : "Indah Rahmadani (2310431019)",
    "Jurusan"          : "Matematika dan Sains Data",
    "Mata ujian"       : "UAP ADP"
}
